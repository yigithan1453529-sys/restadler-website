...
const translations = {
  de: {
    ...
    team1_name:'Küchenchef', team1_role:'Küche & Kreation',
    team1_desc:'Mit Leidenschaft und regionalen Zutaten zaubert unser Küchenchef täglich frische Gerichte — von klassischer Schweizer Küche bis zu modernen Kreationen.',
    team2_name:'Service-Team', team2_role:'Gastfreundschaft',
    team2_desc:'Unser Serviceteam sorgt dafür, dass Sie sich vom ersten Moment an willkommen fühlen — aufmerksam, herzlich und immer mit einem Lächeln.',
    team3_name:'Familie & Leitung', team3_role:'7. Generation · Inhaber',
    team3_desc:'Seit 1825 in Familienbesitz — heute führt die 7. Generation das historische Haus mit Herzblut und dem Respekt für eine jahrhundertealte Tradition.',
  ...
  fr: {
    ...
    team1_name:'Chef de cuisine', team1_role:'Cuisine & Création',
    team1_desc:'Avec passion et des ingrédients régionaux, notre chef crée chaque jour des plats frais — de la cuisine suisse classique aux créations modernes.',
    team2_name:'Équipe de service', team2_role:'Hospitalité',
    team2_desc:'Notre équipe de service veille à ce que vous vous sentiez le bienvenu dès le premier instant — attentif, chaleureux et toujours avec le sourire.',
    team3_name:'Famille & Direction', team3_role:'7e génération · Propriétaires',
    team3_desc:"En mains familiales depuis 1825 — aujourd'hui, la 7e génération dirige la maison historique avec cœur et le respect d'une tradition séculaire.",
  ...
  en: {
    ...
    team1_name:'Head chef', team1_role:'Kitchen & Creation',
    team1_desc:'With passion and regional ingredients, our head chef creates fresh dishes daily — from classic Swiss cuisine to modern creations.',
    team2_name:'Service team', team2_role:'Hospitality',
    team2_desc:'Our service team ensures you feel welcome from the very first moment — attentive, warm and always with a smile.',
    team3_name:'Family & Management', team3_role:'7th generation · Owners',
    team3_desc:'Family-owned since 1825 — today the 7th generation runs the historic house with heart and respect for a centuries-old tradition.',
