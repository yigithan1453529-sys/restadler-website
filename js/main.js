...
const translations = {
  de: {
    ...
    ev_label:'Sommer-Spezialität', ev_title:'Sommer-Fondue',
    ev_date_month:'Juni 2026', ev_date_season:'Sommer 2026',
    ...
    team1_name:'Ainhoa Hidalgo Del Val', team1_role:'Chef de Rang',
    team1_desc:'Mit Herzlichkeit und einem feinen Gespür für die Bedürfnisse der Gäste sorgt Ainhoa dafür, dass jeder Besuch zu einem besonderen Erlebnis wird — charmant, aufmerksam und immer mit Stil.',
    team2_name:'Hugo Juarez', team2_role:'Chef de Cuisine',
    ...
    team4_name:'Adem Tekin', team4_role:'Leitung & Management',
    ...
    team5_name:'Franz Leu', team5_role:'7. Generation · VR & Mitinhaber der Hotel Adler Appenzell AG',
    ...
    team6_name:'Christa Rechsteiner', team6_role:'Restaurationsfachfrau',
    team6_desc:'Mit langjähriger Erfahrung und einem herzlichen Lächeln sorgt Christa dafür, dass sich jeder Gast rundum wohlfühlt — professionell, aufmerksam und immer mit Freude dabei.',
  ...
  fr: {
    ...
    ev_label:'Spécialité estivale', ev_title:'Fondue d\'été',
    ev_date_month:'Juin 2026', ev_date_season:'Été 2026',
    ...
    team1_name:'Ainhoa Hidalgo Del Val', team1_role:'Chef de Rang',
    team1_desc:"Avec chaleur et un sens aigu des besoins des hôtes, Ainhoa veille à ce que chaque visite devienne une expérience unique — charmante, attentive et toujours avec élégance.",
    team2_name:'Hugo Juarez', team2_role:'Chef de Cuisine',
    ...
    team4_name:'Adem Tekin', team4_role:'Direction & Management',
    ...
    team5_name:'Franz Leu', team5_role:'7e génération · CA & Copropriétaire de Hotel Adler Appenzell AG',
    ...
    team6_name:'Christa Rechsteiner', team6_role:'Professionnelle de la restauration',
    team6_desc:"Avec de nombreuses années d'expérience et un sourire chaleureux, Christa veille à ce que chaque hôte se sente pleinement à l'aise — professionnelle, attentive et toujours avec plaisir.",
  ...
  en: {
    ...
    ev_label:'Summer special', ev_title:'Summer Fondue',
    ev_date_month:'June 2026', ev_date_season:'Summer 2026',
    ...
    team1_name:'Ainhoa Hidalgo Del Val', team1_role:'Chef de Rang',
    team1_desc:'With warmth and a keen sense for guests\' needs, Ainhoa ensures that every visit becomes a special experience — charming, attentive and always with style.',
    team2_name:'Hugo Juarez', team2_role:'Chef de Cuisine',
    ...
    team4_name:'Adem Tekin', team4_role:'Management & Operations',
    ...
    team5_name:'Franz Leu', team5_role:'7th generation · Board & Co-owner of Hotel Adler Appenzell AG',
    ...
    team6_name:'Christa Rechsteiner', team6_role:'Restauration Professional',
    team6_desc:'With years of experience and a warm smile, Christa ensures every guest feels completely at ease — professional, attentive and always with joy.',
...
(function () {
  ...
  function injectInstagramBtn() {
    if (document.querySelector('.ig-btn')) return;
    var igBtn = document.createElement('a');
    igBtn.className = 'ig-btn';
    igBtn.href = 'https://www.instagram.com/adler_1825';
    igBtn.target = '_blank';
    igBtn.rel = 'noopener noreferrer';
    igBtn.setAttribute('aria-label', 'Instagram @adler_1825');
    igBtn.innerHTML = '<svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><defs><linearGradient id="ig-grad" x1="0%" y1="100%" x2="100%" y2="0%"><stop offset="0%" stop-color="#f09433"/><stop offset="25%" stop-color="#e6683c"/><stop offset="50%" stop-color="#dc2743"/><stop offset="75%" stop-color="#cc2366"/><stop offset="100%" stop-color="#bc1888"/></linearGradient></defs><path fill="url(#ig-grad)" d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>';
